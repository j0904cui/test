 ...
 * 
 * @version $Id: CollectionUtils.java 5958 2007-02-28 10:29:55Z olamy $
 */
public class CollectionUtils {
	 ...
	 * The cardinality of each element <i>e</i> in the returned {@link Collection} will be the
	 * cardinality of <i>e</i> in <i>a</i> minus the cardinality
	 ...
	 * the given {@link Collection} to an {@link Integer} representing the number of occurances of
	 * that element
